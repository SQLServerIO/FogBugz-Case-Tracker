...
namespace FogBugzNet
{
    public class ImportAnalysis
    {
        ...
        {
            get { return CaseToNewParent.Count == 0; }
        }
        ...
        public string[] Describe()
        {
            ...
            foreach (Case c in CaseToNewParent.Keys)
            {
                ...
                ret.Add(String.Format("Case {0} will be a sub-case of {1}. Here's how it's going to look:", c.ID,
                                      parent.ID));
    ...
    public class Importer
    {
        ...
        private readonly Dictionary<int, Case> _origCases = new Dictionary<int, Case>();
        ...
        {
            get { return _doc.SelectSingleNode("/map/node").Attributes["LINK"].Value; }
        }
